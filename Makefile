...
srcdir = .
top_srcdir = .
prefix = /home/john/SOFTWARES/MIRANDA_DEV_v1/miRanda-1.9/miRanda-1.9-ia64-linux
exec_prefix = ${prefix}
...
pkgdatadir = $(datadir)/miRanda
pkglibdir = $(libdir)/miRanda
pkgincludedir = $(includedir)/miRanda
...
SUBDIRS = man RNAlib src
DIST_SUBDIRS = man RNAlib src
EXTRA_DIST = LICENSE VERSION makebindist.sh examples
ACLOCAL_M4 = $(top_srcdir)/aclocal.m4
mkinstalldirs = $(SHELL) $(top_srcdir)/mkinstalldirs
CONFIG_HEADER = config.h
CONFIG_CLEAN_FILES = 
DIST_COMMON =  README ./stamp-h.in AUTHORS COPYING ChangeLog INSTALL \
Makefile.am Makefile.in NEWS THANKS aclocal.m4 config.guess config.h.in \
